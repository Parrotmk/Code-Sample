 ...
 */
class PMinifyJsCss_Minify_Helper_Data extends Mage_Core_Helper_Abstract
{
	/**
	...
	{
		return (string) Mage::getConfig()->getNode()->modules->PMinifyJsCss_Minify->version;
	}
	...
	public function process()
	{
        ...
        $removeComments = (int) Mage::getConfig()->getNode('PMinifyJsCss_minify/minify_css_js/remove_comments', 'default');
